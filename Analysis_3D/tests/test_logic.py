...
Run with Blender Python: blender --background --python-expr "import pytest; pytest.main(['tests'])"
or with unittest inside Blender.
"""
...
try:
    ...
    from analisisV6.utils import calculate_hausdorff_distance_from_coords, calculate_similarity_from_coords
...
class TestCSVAnalytics(unittest.TestCase):
    def test_compute_metrics_for_csv_isolated_temporal_pause_and_speed(self):
        ...
        # A1 se expresa en minutos.
        self.assertAlmostEqual(metrics["A1"][-1], 109 / 60.0, places=6)
