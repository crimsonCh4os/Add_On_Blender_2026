...
\begin{itemize}
    ...
    \item Analizar los CSV generados para obtener métricas estadísticas A1--A16 sobre la sesión de modelado.
...
\begin{description}
    ...
    \item[RF-29 Métricas A1--A16.] El sistema debe calcular el conjunto de métricas estadísticas A1--A16 definidas para caracterizar la sesión de modelado.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{diagramas/casos_de_uso.png}
...
\begin{tabularx}{\linewidth}{p{0.23\linewidth}X}
\toprule
\textbf{CU-09} & Calcular métricas estadísticas A1--A16 \\
\midrule
...
\textbf{Postcondición} & Las métricas A1--A16 quedan disponibles para su presentación en paneles. \\
\textbf{Excepciones} & Series temporales incompletas, duración nula o ausencia de columnas necesarias. \\
\textbf{Prioridad} & Alta \\
\bottomrule
\end{tabularx}
\caption{CU-09: Calcular métricas estadísticas A1--A16.}
\label{tab:cu9}
\end{table}
