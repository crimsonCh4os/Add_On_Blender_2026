...
El propósito principal de este proyecto es el desarrollo, y ejecución de un sistema de software modular destinado a registrar, analizar y mostrar las interacciones del usuario en entornos de modelado tridimensional, utilizando Blender como base para tal desarrollo~\cite{pressman2005}.
