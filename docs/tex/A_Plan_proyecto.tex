...
El tercer sprint tuvo como objetivo iniciar el segundo add-on de la \textit{suite}. La planificación contemplaba la lectura de CSV, el cálculo de primeras métricas temporales y espaciales, y una interfaz inicial para el análisis.
...
La ejecución real muestra la incorporación de un CSV real procedente de la actividad realizada en la EASD, Escuela de Arte y Superior de Diseño de Burgos, así como varias correcciones sobre \texttt{Calculate CSV Metric Stats} y métricas CSV múltiples. También se llevó a cabo la reestructuración de anexos e integración completa del segundo add-on en la documentación del TFG.
...
Sprint 3 & Marzo semanas 1--2 & Add-on de análisis, lectura CSV y primeras métricas. & Integración inicial del análisis temporal y espacial. \\
...
Sprint 6 & Abril semanas 3--4 & Análisis estadístico, métricas CSV y gráficos. & Add-on de análisis más completo. \\
...
\textbf{Sprint 0} &
Definir requisitos, alcance y arquitectura de dos add-ons. &
Se mantuvo la arquitectura modular, aunque el add-on de análisis adquirió mayor alcance. \\
...
Aunque el proyecto se enmarca en un contexto académico, puede estimarse un coste equivalente de desarrollo tomando como referencia una dedicación de cuatro meses y una remuneración mensual aproximada de 1200 euros para un perfil junior:
...
\[
100\,\text{euros} + 4800\,\text{euros} = 4900\,\text{euros}
\]
...
A pesar de estas desviaciones, la planificación permitió mantener una dirección clara. La \textit{suite} evolucionó desde un logger inicial hasta un sistema formado por dos add-ons complementarios, con captura automática, exportación CSV, análisis estadístico, métricas geométricas, métricas UV, visualizaciones e interfaz organizada por pestañas.
