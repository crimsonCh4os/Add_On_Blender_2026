...
Otra línea de investigación se orienta para entender cómo trabaja el diseñador y cómo cambia su comportamiento según su experiencia y nivel de especialización~\cite{casakin2023,chen2022,welch}.
...
\textbf{Limitación:} Los estudios mencionados dependen exclusivamente de dispositivos especializados y plataformas inmersivas de realidad mixta, lo que limita su aplicación práctica en software de modelado de uso común y pantallas tradicionales.
...
Koh et al. (2010)       & X & X &   &   \\
\textbf{Add-on 1.0}     & \textbf{X} & \textbf{X} & \textbf{X} & \textbf{X} \\
