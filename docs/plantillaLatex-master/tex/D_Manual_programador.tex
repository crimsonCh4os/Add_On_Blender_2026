...
\subsection{Paneles de depuración y monitorización}
...
La Figura~\ref{fig:data_logger_con_debug} muestra el panel de depuración utilizado por el addon de recopilación.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.32\textwidth]{diagramas/data_logger_con_debug.png}
    \caption{Panel de depuración del addon de recopilación.}
...
\begin{itemize}
    \item estado del sistema de captura,
    \item temporizadores activos,
    \item último operador detectado,
    \item cambios de estado registrados,
    \item detección de coordenadas UV,
    \item operaciones como Shift+D, Ctrl+V o Merge,
    \item y modo actual de Blender.
\end{itemize}
...
El addon de análisis incorpora una interfaz similar, adaptada a la visualización y procesamiento de métricas.
