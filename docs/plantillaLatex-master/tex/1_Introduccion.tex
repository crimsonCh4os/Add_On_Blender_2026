...
Finalmente, la memoria concluye con un apartado de conclusiones y posibles líneas de trabajo futuro derivadas del sistema desarrollado, además de los anexos, donde se incluye información complementaria del proyecto.